...
$allUrl      = route_url('orders.buying');
$disputedUrl = route_url('orders.buying', ['filter' => 'disputed']);
$refundedUrl = route_url('orders.buying', ['filter' => 'refunded']);
$sellingUrl  = route_url('orders.selling');
...
<div class="container py-5" style="max-width: 1100px;">
    ...
    <div class="orders-page-header">
        <div>
            <h2 class="fw-bold mb-1">Đơn hàng mua</h2>
            <p class="text-muted mb-0">Theo dõi các đơn hàng bạn đã đặt mua và tiến trình giữ tiền an toàn.</p>
            <p class="order-filter-subtitle mb-0">Đang xem: <?php echo htmlspecialchars($filterLabel); ?></p>
        </div>
        <a href="<?php echo $sellingUrl; ?>" class="orders-switch-btn">
    ...
    <div class="order-list">
        ...
        $sellerName   = trim((string) ($order['seller_name'] ?? ''))   ?: 'Người bán đang cập nhật';
            ...
            <div class="d-flex gap-3 flex-wrap">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="order-list-meta">
                        <span><i class="fa-solid fa-user"></i> Người bán: <?php echo htmlspecialchars($sellerName); ?></span>
